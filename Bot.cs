...
namespace YoutuBot
{
    internal class Bot
    {
        private static int _newlyFoundVideosCount;
        ...
        public BlockingCollection<KeyValuePair<string, string>> _queue =
        ...
        private void ExtendVideo(string videoId, bool useCache, int level)
        {
            ...
            {
                if (useCache)
                    if (_videoCache.Contains(videoId))
                        return;
        ...
        public void ExtendAllVideos()
        {
            ...
            var videoIds = Sql
                ...
                .ToList();
            foreach (var videoId in videoIds) _videoCache.Add(videoId);
                ...
                try
                {
                    ...
                    foreach (var comments in commentsBatch)
                        try
                        {
                            ...
                            foreach (var comment in comments) comment.VideoId = videoId;
